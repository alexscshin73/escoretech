...
export default function WhySCoreTech() {
  ...
  return (
    <section className="py-24 bg-[#4A6FA5]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {w.items.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[#C0556A]/20 flex items-center justify-center mb-5">
                  <Icon size={24} className="text-[#C0556A]" />
                </div>
